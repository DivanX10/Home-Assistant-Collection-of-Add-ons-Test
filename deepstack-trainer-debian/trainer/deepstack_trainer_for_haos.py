...
src_file_db=r'/opt/trainer/db'
dest_file_db = r'os.getenv("HOMEASSISTANT_FOLDER_PATH_FOR_DATABASE")'
...
def SaveImage(file, path):
    ...
    try:
        with open(path, "wb") as buffer:
            ...
            shutil.copy2(src_file_db, dest_file_db) #copy the database from docker to homeassistant
...
def home(request: Request):
    ...
    #shutil.copy2(src_file_db_bkp, dest_file_db_bkp) #copy the database from homeassistant to docker 
